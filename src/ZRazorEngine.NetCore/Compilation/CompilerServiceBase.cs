...
";
            ...
            using (var reader = context.TemplateContent.GetTemplateReader())
            {
                ...
                var templateEngine = new Templating.RazorTemplateEngine(razorEngine, razorProject);
        ...
        private static RazorPageGeneratorResult GenerateCodeFile(Templating.RazorTemplateEngine templateEngine, RazorProjectItem projectItem)
        {
        ...
        private static RazorPageGeneratorResult GenerateCodeFile(Templating.RazorTemplateEngine templateEngine, RazorCodeDocument document)
        {
